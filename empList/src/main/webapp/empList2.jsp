...
<body>
	...
	<div class="content">
		...
		<table>
			<tr>
				...
				<th>
					birthDate
					<a href="./empList.jsp?col=birth_date&aseDesc=ASC">[asc]</a>
					<a href="./empList.jsp?col=birth_date&aseDesc=DESC">[desc]</a>
				</th>
				<th>
					age
	...
	<footer>
		<%
				if(currentpage > 1){
			%>
					<a href="./empList2.jsp?currentpage=<%=currentpage-1%>&gender=<%=gender%>"style="float: left; padding-left: 10px;"><img alt="+" src="./img/next1.png"></a>
			<%		
				}
				if(currentpage < lastPage){
			%>
					<div style="margin-top: 30px; font-size: 25px; text-align: center;" ><%=currentpage %> 페이지	
					<a href="./empList2.jsp?currentpage=<%=currentpage+1%>&gender=<%=gender%>"style="float: right; padding-right: 10px;"><img alt="+" src="./img/next.png"></a></div>
			<%		
				}
			%>
	</footer>
